...
namespace DT.UniStart {
  ...
  public class AdvancedEvent<T0> : AdvancedEvent, IWatchable<T0> {
  ...
  public class AdvancedEvent<T0, T1> : AdvancedEvent, IWatchable<T0, T1> {
  ...
  public class AdvancedEvent<T0, T1, T2> : AdvancedEvent, IWatchable<T0, T1, T2> {
  ...
  public class AdvancedEvent<T0, T1, T2, T3> : AdvancedEvent, IWatchable<T0, T1, T2, T3> {
